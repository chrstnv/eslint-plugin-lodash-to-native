...
ruleTester.run('map', rule, {
  valid: [
    ...
    'const obj = {a : 1, b: 2}; let a =  _.map(obj, n => {n * n})',
    ...
    // when the '_' variable declared and assigned once
  ...
  invalid: [
    ...
    {
      code:
        'function getArray1() { return [23, 23]; }; var a = _.map(getArray1(), (n) => {n * n})',
      errors: [
        {
    ...
    {
      code:
        'function getArray1() { return [23, 23]; }; let a = getArray1(); let b = _.map(a, (n) => {n * n})',
      errors: [
        {
          message: 'There should be conditional native Array#map here.'
        }
